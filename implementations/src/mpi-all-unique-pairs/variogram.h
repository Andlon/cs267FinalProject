...
/**
 * @brief empirical_variogram_parallel Computes an empirical variogram of the data in the given
 * input file by sharing the workload across available (MPI) processors, using the
 * given number of bins to categorize the data points.
 *
 * The returned data is only valid on the root node (rank 0), and undefined for all other processors.
 *
